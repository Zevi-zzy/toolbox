        ...
        <div className="flex flex-col items-center">
          ...
          {resumeData ? (
            ...
            >
              ...
              {/* 底部 */}
              <div className="p-6 bg-gray-50/50 flex items-center justify-center border-t border-gray-100">
                <div className={`w-1.5 h-1.5 rounded-full ${currentTheme.primary} mr-2 opacity-40`}></div>
                <p className="text-[9px] font-black text-gray-400 tracking-[0.2em] uppercase">
                  Professional Resume Generated by Toolbox
                </p>
              </div>
            </div>
          ) : (
